...
home_folder{1} = dir( 'FIU/home/casa' ) ;
...
%                 % FFT_1min
%                 bin_1_mnt = [0 : ceil( ts_bin_30mnt(end) / 1 )-1 ; 1 : ceil( ts_bin_30mnt(end) / 1 )]*1 ;
%                 bin_1_mnt(end) = bin_1_mnt(end) ;
%                 
%                 i_fall_1mnt = ts_bin_30mnt >= bin_1_mnt(1,:) & ts_bin_30mnt < bin_1_mnt(2,:) ;
%                 
%                 count_read_bin_1mnt = [ ] ; 
%                 size_read_bin_1mnt = [ ] ; 
%                 
%                 count_write_bin_1mnt = [ ] ; 
%                 size_write_bin_1mnt = [ ] ; 
%                 
%                 for i_bin_1mnt = 1 : size(i_fall_1mnt,2)
%                     
%                     % read
%                     read_bin_1mnt = read_bin_30mnt(i_fall_1mnt(: , i_bin_1mnt) , 1) ;
%                     read_size_bin_1mnt = read_size_bin_30mnt(i_fall_1mnt(: , i_bin_1mnt) , 1) .* read_bin_1mnt ;
%                     lba_read_bin_30mnt = read_bin_1mnt(read_bin_1mnt==1) ;
%                     count_read_bin_1mnt_temp = length(lba_read_bin_30mnt) ;
%                     
%                     count_read_bin_1mnt = [count_read_bin_1mnt ; count_read_bin_1mnt_temp] ;
%                     size_read_bin_1mnt = [size_read_bin_1mnt ; mean(read_size_bin_1mnt)] ;
%                     %
%                     
%                     % write
%                     write_bin_1mnt = write_bin_30mnt(i_fall_1mnt(: , i_bin_1mnt) , 1) ;
%                     write_size_bin_1mnt = write_size_bin_30mnt(i_fall_1mnt(: , i_bin_1mnt) , 1) .* write_bin_1mnt ;
%                     lba_write_bin_30mnt = write_bin_1mnt(write_bin_1mnt==1) ;
%                     count_write_bin_1mnt_temp = length(lba_write_bin_30mnt) ;
%                     
%                     count_write_bin_1mnt = [count_write_bin_1mnt ; count_write_bin_1mnt_temp] ;
%                     size_write_bin_1mnt = [size_write_bin_1mnt ; mean(write_size_bin_1mnt)] ;
%                     %
%                     
%                 end
%                 
%                 data_temp = [count_read_bin_1mnt size_read_bin_1mnt ...
%                                 count_write_bin_1mnt size_write_bin_1mnt] ; 
%                 data_temp = data_temp - mean(data_temp) ; 
%                 
%                 fft_data = Fourier_Transform(data_temp, 1, 1 , 1) ; 
%                 frequency = fft_data.Frequency_One_Sided ; 
%                 magnitude = fft_data.Magnitude_One_Sided ;
% 
%                 fft_mag_1 = mean( magnitude(frequency>=0 & frequency<0.125 , :) ) ; 
%                 fft_mag_2 = mean( magnitude(frequency>=0.125 & frequency<0.25 , :) ) ; 
%                 fft_mag_3 = mean( magnitude(frequency>=0.25 & frequency<0.375 , :) ) ; 
%                 fft_mag_4 = mean( magnitude(frequency>=0.375 & frequency<0.5 , :) ) ; 
...
save([folder_fiu 'home/casa_fiu_data.mat'] , ...
    'count_read_bin_30mnt' , ...
    'size_read_bin_30mnt' , ...
    'sl_read_bin_30mnt' , ...
    'burst_read_bin_30mnt' , ...
