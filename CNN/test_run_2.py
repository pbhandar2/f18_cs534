...
print("Num GPU: {}, Learning Rate: {}, Batch Size: {}, Num Epochs: {}, Dropout: {}, L2: {}, Hidden: {}, num_layer: {}".format(gpu_count, learning_rate, batch_size, num_epochs, dropout, l2, num_hidden_nodes, num_layer))


# image transformations
transformations = transforms.Compose([transforms.ToTensor()])
criterion = nn.CrossEntropyLoss()
model = ConvNet(num_hidden_nodes=num_hidden_nodes)
model.cuda()
...
train_block_loader = BlockDataLoader("./5_test/train_index.csv", transformations=transformations)
test_block_loader = BlockDataLoader("./5_test/test_index.csv", transformations=transformations)
#val_block_loader = BlockDataLoader("./5_test/val.csv", transformations=transformations)
...
#torch.save(model.state_dict(), 'model_{}_{}_{}_{}_100.ckpt'.format(learning_rate, batch_size, num_epochs, num_hidden_nodes))